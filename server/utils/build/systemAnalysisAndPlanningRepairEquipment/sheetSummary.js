...
module.exports = function({ data, plan, ws, defaultStyle, borderStyle }) {
    ...
    // Наименования узлов
    ws.cell(12, 1).string('Узел алмажения')
    ws.cell(13, 1).string('Шпиндельный узел')
    ws.cell(14, 1).string('Узел гидравлики')
    ws.cell(15, 1).string('Узел пневматики')
    ws.cell(16, 1).string('Узел загрузки-выгрузки')
    ws.cell(17, 1).string('Узел главного привода')
    ws.cell(18, 1).string('Узел коробки скоростей, подач')
    ws.cell(19, 1).string('Узел наладочного привода')
    ws.cell(20, 1).string('Узел траверса')
    ws.cell(21, 1).string('Узел суппорта')
    ws.cell(22, 1).string('Узел системы смазки')
    ws.cell(23, 1).string('Узел блоков питания')
    ws.cell(24, 1).string('Узел электронных плат')
    ws.cell(25, 1).string('Узел логических элементов')
    ws.cell(26, 1).string('Узел асинхронного двигателя')
    ws.cell(27, 1).string('Узел двигателя постоянного тока')
    ws.cell(28, 1).string('Узел электропривода')
    ws.cell(29, 1).string('Узел бесконтактных датчиков')
    ws.cell(30, 1).string('Узел электроаппаратуры')
    ws.cell(31, 1).string('Узел цепей управления, силовых цепей')
    ws.cell(32, 1).string('Узел электромеханических муфт')

...
const INDEXES_TECHNOLOGY = require(appRoot + '/server/config/laboratory/shsp/technology')
const INDEXES_FACT = require(appRoot + '/server/config/laboratory/shsp/fact')

...
const INDEXES_FACT_DATE_SHP = require('../config/laboratory/shp/fact')['date']
const INDEXES_FACT_DATE_SHSP = require('../config/laboratory/shsp/fact')['date']
const INDEXES_FACT_DATE_SOG = require('../config/laboratory/sog/fact')['date']
